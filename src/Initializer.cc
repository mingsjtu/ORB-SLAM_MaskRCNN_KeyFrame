                            ...
                            cv::Mat &R21, cv::Mat &t21, vector<cv::Point3f> &vP3D, vector<bool> &vbTriangulated, float minParallax, int minTriangulated)
{
    ...
    if(nGood4>0.7*maxGood)
        nsimilar++;
    //printf("nMinGood %d,nGood1 %d, nGood2 %d, nGood3 %d, nGood4 %d\n",nMinGood,nGood1,nGood2,nGood3,nGood4);
                      ...
                      cv::Mat &R21, cv::Mat &t21, vector<cv::Point3f> &vP3D, vector<bool> &vbTriangulated, float minParallax, int minTriangulated)
{
    ...
    if(secondBestGood<0.75*bestGood && bestParallax>=minParallax && bestGood>minTriangulated && bestGood>0.7*N)
    {
